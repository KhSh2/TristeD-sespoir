...
describe "#multiply" do
  ...
  it "multiplies two other numbers" do 
    ...
    # one other test here, don't forget do end ;) OK 

  it "multiplies two other numbers, one of them being 0" do 
    expect (multiply(0,5)).to eq(0)
  end
    # one last test, with 0 in it OK

end

describe "#power" do
  it "raises one number to the power of another number" do 
    expect (power(2,3)).to eq(8) #OK
  end
end
...
describe "#factorial" do
  it "computes the factorial of 0" do 
    expect (factorial(0)).to eq(1) #OK
  end
  it "computes the factorial of 1" do 
    expect (factorial(1)).to eq(1) #OK
  end
  it "computes the factorial of 2" do 
    expect (factorial(2)).to eq(2) #OK
  end
  it "computes the factorial of 5" do 
    expect (factorial(5)).to eq(120) #OK
  end
  it "computes the factorial of 10" do 
    expect (factorial(10)).to eq(3628800) #OK
  end
end
