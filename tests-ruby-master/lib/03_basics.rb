...
puts [1, [2, 3], 4, 5, 6, 23, 31, [1, 2, 3]].reject{|a| a % 3 == 0}.map{|e| e * 2 if e.is_a? Numeric}.compact.flatten.sort.uniq
...
#puts [1, [2, 3], 4, 5, 6, 23, 31, [1, 2, 3]].reject{|a| a % 3 == 0}.map{|e| e * 2 if e.is_a? Numeric}.compact.reject{|a| a % 3 == 0}